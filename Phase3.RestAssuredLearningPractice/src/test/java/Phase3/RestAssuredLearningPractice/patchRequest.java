...
public class patchRequest {
	...
	private static final Logger logger = Logger.getLogger(patchRequest.class);
	...
	public void putRequestTest() {
		...
		try {
			...
			.and().assertThat().body("name", equalTo(postData.name))
			.and().assertThat().body("job", equalTo(postData.job));
