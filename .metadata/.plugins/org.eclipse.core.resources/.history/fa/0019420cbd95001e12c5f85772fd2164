...
public class add_transac1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect("transaction1.html");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// start a trasaction 
			connection.setAutoCommit(false); //Disables the auto commit
			//connection.setAutoCommit(true); //Enables the auto commit
